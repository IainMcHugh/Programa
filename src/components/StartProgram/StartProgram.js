...
// export class StartProgram extends React.Component {
//   constructor(props) {
//     super(props);
...
//         database
//           .ref("programs/" + this.state.program_id)
//           .once("value")
//           .then((snap) => {
//             this.setState({
...
//       });
//       document
//         .getElementsByClassName("handle-timer-button")[0]
//         .setAttribute("id", "off");
//     } else {
//       var _this = this;
//       this.incrementer = setInterval(() => {
...
//     } else {
//       prevSPExercise2[activeExerciseId][1][prevRows[activeExerciseId]] =
//         e.target.value;
//     }
//     this.setState({
...
//     if (
//       prevRows[activeExerciseId] == prevSPExercise2[activeExerciseId][0].length
//     ) {
...
//                     {Array.from(
//                       Array(SPExercises2[index1][0].length),
//                       (e, i) => {
//                         return (
...
//                               >
//                                 {typeof SPExercises2[index1][i][j] !==
//                                 "boolean" ? (
